...
class Worker(QThread):
    ...
    def set_light(self, off=True):
        Rm.set_Light(self.robo_connection, off)
...
class MainObjectWidget(QWidget):
    ...
    def __init__(self, screen_width, screen_height, parent=None):
        ...
        self.detector.addItems(['None','Scratch', 'AI'])
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, screen_width = None, screen_height = None):
        ...
        self.UnetModel, self.device = predict.getModel(rootDir +"Src/unet/MODEL.pth")#'C:/Prj/Robopick/Depot.svn/Src/unet/MODEL.pth')
        ...
        try:
            ...
            if os.path.isfile('C:/Prj/Robopick/Depot.svn/images/temp/temp_save.png'):
                ...
                if Final_image:
                    ...
                    elif self.props.detector.currentText() == self.props.detector.itemText(2):
                        mask = predict.predict_img(self.UnetModel, full_img_path='C:/Prj/Robopick/Depot.svn/images/temp/temp_save.png', device=self.device, scale_factor=1, out_threshold=0.1)
