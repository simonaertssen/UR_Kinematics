...
def get_camera(serial_number = '22290932'):
    ...
    attempt = 0
    #print("Camera",1)
    while info is None and attempt < 20:
        attempt += 1
        #print("Camera", 2)
...
def save_image(save, path_save, show, text = "", image = None, path_show='C:/Prj/Robopick/Depot.svn/images/temp/temp.png', cam_serial=F"21565643", camera = None):
    counter = 0
    img = image
